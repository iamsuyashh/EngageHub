...
from EngageHub.pages import galleryPage, home, signUp, signIn,register,event,about,admin_page,eventInfo,livestream, upcomingEvents,adminEventPage
...
# app.setup_admin_dash(admin_page)
app.compile()