...
def about_page():
    ...
    return rx.box(
        rx.heading("About Engage Hub", style={"color": "indigo", "text-align": "center" , "margin-bottom":"10px"}),
        rx.text(
        ...
        rx.heading("Our Mission", style={"color": "indigo", "text-align": "center","margin-bottom":"10px"}),
        rx.text(
        ...
        rx.heading("Features", style={"color": "indigo", "text-align": "center" , "margin-bottom":"10px"}),
        rx.box(
        ...
        rx.heading("Why Choose Engage Hub?", style={"color": "indigo", "text-align": "center" , "margin-bottom":"10px"}),
        rx.box(
